        ...
        <div class="container-fluid"><?php if($error_warning): ?>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left"><?php if($sort == 'order_id'): ?> <a
                                                    ...
                                                    <a href="<?php echo $sort_order; ?>"><?php echo $column_order_id; ?></a> <?php endif; ?>
                                            </td>
                                        ...
                                        <?php if(!empty($deliveries)): ?>
                                            <?php foreach($deliveries as $delivery): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-left"><?php echo $delivery['im_id']; ?></td>
                                                    <td class="text-left">
                                                        <?php if($delivery['label']): ?>
            ...
            <script type="text/javascript"><!--
                $('#button-filter').on('click', function () {
                    ...
                    location = 'index.php?route=sale/boxberry&<?php echo (strpos(VERSION, '2.') === 0 ? 'token' : 'user_token') ;?>=<?php echo (strpos(VERSION, '2.') === 0 ? $token : $user_token) ;?>' + url;
                });
                //--></script>
        </div>
<?php echo $footer; ?>